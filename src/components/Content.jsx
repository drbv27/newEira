        ...
        <div className="flex items-center mb-3 sm:justify-center">
          ...
          <a href="/" className="transition duration-300 hover:shadow-xl">
            ...
            <div className="flex flex-col items-center">
              <div className="mb-2 text-sm text-gray-600 md:mb-2 dark:text-slate-300">Follow us</div>
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  <a
                    href="/"
                    className="dark:text-slate-300 text-gray-600 transition-colors duration-300 hover:text-eiraclaro-500"
                  >
